            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Text("User Info", style: CoinTextStyle.orangeTitle3),
                    const SizedBox(height: 4.0),
                    const MyDataRow(title: "User ID", value: "5630918957"),
                    const MyDataRow(title: "User Name", value: "Tan Qing Fong"),
                    const MyDataRow(
                        title: "Email", value: "qingfong@gmail.com"),
                    const SizedBox(height: 6.0),
                    const Divider(),
                    const SizedBox(height: 12.0),
                    Text("Draws", style: CoinTextStyle.orangeTitle3),
                    const MyDataRow(title: "Number of Draws", value: "5"),
                    const MyDataRow(title: "Total Points", value: "250"),
                    const SizedBox(height: 6.0),
                    const Divider(),
                    const SizedBox(height: 12.0),
                    Text("Pool Info", style: CoinTextStyle.orangeTitle3),
                    const MyDataRow(
                        title: "Pool Name", value: "Imperdiet Ex Non"),
                    const MyDataRow(
                        title: "Participate ID", value: "#33895583"),
                    const MyDataRow(title: "Total Point", value: "350"),
                    const MyDataRow(
                        title: "Pool Period", value: "1/5/2022 - 31/5/2022"),
                    const MyDataRow(title: "Draw Time", value: "1/6/2022"),
                    const MyDataRow(
                        title: "Rewards", value: "Iphone 13 Pro Max 256G"),
                    const SizedBox(height: 6.0),
                    const Divider(),
