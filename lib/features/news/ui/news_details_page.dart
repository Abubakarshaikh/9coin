...
class NewsDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      vice-president C. Krishnan said people often relied on chicken-based meals for their daily consumption as it was cheaper compared to other meats or eafood. ''',
